                    ...
                    <div class="channels-content">
                        ...
                        <div class="theme-section">
                            <div class="row">
                                ...
                                @php
                                $videoCount = App\Models\ChannelVideo::where('channel_id',$channel->channel->id)->count();
                                @endphp
                                <div class="col-md-3 col-sm-4">
                                    <div class="cns-block">
                                        <a href="{{route('home.channel.details',[$channel->channel->id,$channel->channel->slug])}}" class="cns-image">
                                            <img src="{{asset($channel->channel->image)}}" alt="image">
                                        </a>
                                        <div class="cns-img-small">
                                            <div class="cns-small-wrapp">
                                                <img src="{{asset($channel->channel->user->profile_photo_path)}}" alt="small">
                                            </div>
                                        </div>
                                        <div class="cns-info">
                                            <h5>{{$channel->channel->name}}<I class="arrow"></I></h5>
