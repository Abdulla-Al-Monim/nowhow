                ...
                <div class="content-block">
                    ...
                    <div class="channels-content">
                        ...
                        <div class="theme-section">
                            <div class="row">
                                @foreach($podcastTags as $data)
                                @php
                                $podcastAudioCount = App\Models\PodcastAudio::where('podcast_id',$data->podcast->id)->count();
                                @endphp
                                <div class="col-md-3 col-sm-4">
                                    <div class="cns-block">
                                        <a href="{{route('home.podcast.details',[$data->podcast->id,$data->podcast->slug])}}" class="cns-image">
                                            <img src="{{asset($data->podcast->image)}}" alt="image">
                                        </a>
                                        <div class="cns-img-small">
                                            <div class="cns-small-wrapp">
                                                <img src="{{asset($data->podcast->user->profile_photo_path)}}" alt="small">
                                            </div>
                                        </div>
                                        <div class="cns-info">
                                            <h5>{{$data->podcast->name}}<I class="arrow"></I></h5>
                                            <span>27,548 Subscribers</span>
                                            <span>{{$podcastAudioCount}} Books</span>
