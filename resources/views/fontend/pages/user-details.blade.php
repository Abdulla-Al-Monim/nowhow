                            ...
                            <div class="c-details">
                                ...
                                <div class="c-sub pull-right hidden-xs">
                                    <div class="c-sub-wrap">
                                        ...
                                        @auth
                                        @php
                                        $subscrive = App\Models\UserSubscrive::where('user_id',Auth::user()->id)->where('subscrive_user_id',$user->id)->count();
                                        @endphp
                                        @if($subscrive > 0)
                                        <a href="{{route('user.un.subscribe',[Auth::user()->id,$user->id])}}" class="sub-a">Subscribed</a>
                                        @else
                                        @if($user->id == Auth::user()->id)
                                        Subscribe
                                        @else
                                        <a href="{{route('user.subscribe',$user->id)}}" class="sub-a">Subscribe</a>
                                        @endif
                                        @endif
