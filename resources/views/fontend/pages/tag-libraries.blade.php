                ...
                <div class="content-block">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-sm-8 col-xs-10">
                                <ul class="list-inline">
                                    <li><a href="#" class="color-active">Browse All Libraries</a></li>
                    ...
                    <div class="channels-content">
                        ...
                        <div class="theme-section">
                            <div class="row">
                                @foreach($librariyTags as $data)
                                @php
                                $libraryBookCount = App\Models\LibraryBook::where('library_id',$data->librariry->id)->count();
                                @endphp
                                <div class="col-md-3 col-sm-4">
                                    <div class="cns-block">
                                        <a href="{{route('home.library.details',[$data->librariry->id,$data->librariry->slug])}}" class="cns-image">
                                            <img src="{{asset($data->librariry->image)}}" alt="image">
                                        </a>
                                        <div class="cns-img-small">
                                            <div class="cns-small-wrapp">
                                                <img src="{{asset($data->librariry->user->profile_photo_path)}}" alt="small">
                                            </div>
                                        </div>
                                        <div class="cns-info">
                                            <h5>{{$data->librariry->name}}<I class="arrow"></I></h5>
                                            <span>27,548 Subscribers</span>
                                            <span>{{$libraryBookCount}} Books</span>
