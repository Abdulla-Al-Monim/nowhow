                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form class="simple-example" action="javascript:void(0);" novalidate>
                                        ...
                                        <button class="btn btn-primary submit-fn mt-2" id="addBtn" onclick="addData()" type="submit">Add Category</button>
                                    </form>
	...
	function clearData(){
     ...
     function allData() {
        $.ajax({
          type: "GET",
          dataType: "json",
          url: "/admin/template/category/all",
	 ...
	 function addData(){
        ...
        $.ajax({
          ...
          dataType: "json",
          data: {name:name},
          url: "/admin/template/category/store",
