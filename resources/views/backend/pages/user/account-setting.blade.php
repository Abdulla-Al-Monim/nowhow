                        ...
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form id="general-info" class="section general-info" enctype="multipart/form-data" action="javascript:void(0);">
                                    @csrf
                                        <div class="info">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-11 mx-auto">
                                                    <div class="row">
                                                        ...
                                                        <button class="btn btn-primary submit-fn mt-2" id="addIBtn" onclick="addIData()" type="submit">Update</button>      
                                                            ...
                                                            <div class="col-xl-2 col-lg-12 col-md-4">
                                                                <div class="upload mt-4 pr-md-4">
                                                                    <input type="file" id="input-file-max-fs" name="image" class="dropify" data-default-file={{(Auth::user()->profile_photo_path)}} data-max-file-size="2M" />
                                                                ...
                                                                <div class="form">
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <input type="hidden" name="pro" value="{{asset(Auth::user()->profile_photo_path)}}">
                                                                        </div>
                                                                        <div class="col-sm-6">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form id="about" method ="POST" class="section about" class="simple-example" action="javascript:void(0);">
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 text-right mb-5">
                                                    <button id="addBtn" onclick="addData()" class="btn btn-primary submit-fn mt-2" > Update</button>
                                                </div>
                                                <div class="col-xl-2 col-lg-12 col-md-4">
                                                    <div class="upload mt-4 pr-md-4">
                                                        ...
                                                        <p class="mt-2"><i class="flaticon-cloud-upload mr-1"></i> Cover Photo</p>
                                                    </div>       
                                                </div>
                                                <div class="col-md-8 col-xl-10 mx-auto">
                                                    <div class="form-group">
                                                        <label for="aboutBio">Bio</label>
                                                        <textarea class="form-control" name="aboutBio" id="aboutBio" placeholder="Tell something interesting about yourself" rows="10"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                <form id="contact-info" class="section general-info" enctype="multipart/form-data" action="javascript:void(0);">
                                    @csrf
                                        <div class="info">
                                            <h5 class="">Contact</h5>
                                            <div class="row">
                                            <div class="col-md-12 text-right mb-5">
                                                    <button id="addCBtn" onclick="addCData()" class="btn btn-primary submit-fn mt-2" > Update</button>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="address" class="form-control mb-4" id="address" placeholder="Address" value="New York" >
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="location" class="form-control mb-4" id="location" placeholder="Location">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="phone">Phone</label>
                                                                <input type="text" name="phone" class="form-control mb-4" id="phone" placeholder="Write your phone number here" value="+1 (530) 555-12121">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="web_site" class="form-control mb-4" id="website1" placeholder="Write your website here">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form id="social" class="section social" action="javascript:void(0);">
                                        <div class="info">
                                            <h5 class="">Social</h5>
                                            <div class="row">
                                                <div class="col-md-12 text-right mb-5">
                                                    <button id="addSBtn" onclick="addSData()" class="btn btn-primary submit-fn mt-2" > Update</button>
                                                </div>
                                                <div class="col-md-11 mx-auto">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="input-group social-linkedin mb-3">
                                                                ...
                                                                <input type="text" id = "" name="linkenin" class="form-control" placeholder="linkedin Username" aria-label="Username" aria-describedby="linkedin" value="jimmy_turner">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group social-tweet mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="twitter" placeholder="Twitter Username" aria-label="Username" aria-describedby="tweet" value="@jTurner">
                                                            </div>
                                                        </div>                                                        
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="input-group social-fb mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="facebook" placeholder="Facebook Username" aria-label="Username" aria-describedby="fb" value="Jimmy Turner">
                                                            </div>
                                                        </div>
...
@section("script")
	...
	function clearData(){
     ...
     $('#general-info').on('submit', function(event){
            event.preventDefault();
      $.ajax({
       url:"{{ url('http://127.0.0.1:8000/api/update-accout-detail-route-ajax') }}",
       method:"POST",
       data:new FormData(this),
       dataType:'JSON',
       contentType: false,
...
<script type="text/javascript">
	...
	function clearData(){
     ...
     $('#contact-info').on('submit', function(event){
            event.preventDefault();
      $.ajax({
       url:"{{ url('/user/update-account-contact-ajax') }}",
       method:"POST",
       data:new FormData(this),
       dataType:'JSON',
       contentType: false,
	...
	function clearData(){
     ...
     $('#social').on('submit', function(event){
            event.preventDefault();
      $.ajax({
       url:"{{ url('/user/update-account-social-ajax') }}",
       method:"POST",
       data:new FormData(this),
       dataType:'JSON',
       contentType: false,
